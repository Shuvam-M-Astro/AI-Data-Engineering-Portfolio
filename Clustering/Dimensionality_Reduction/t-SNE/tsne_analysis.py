...
from sklearn.datasets import load_breast_cancer, load_iris, make_blobs, make_swiss_roll
...
class TSNEAnalysis:
    ...
    def __init__(
        self, n_components=2, perplexity=30.0, learning_rate="auto", n_iter=1000, random_state=42
    ):
        """
