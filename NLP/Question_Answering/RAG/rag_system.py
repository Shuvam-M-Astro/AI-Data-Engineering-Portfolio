...
class RAGSystem:
    def __init__(self):
        ...
        self.llm = ChatOpenAI(temperature=0.0, model_name=os.getenv("OPENAI_MODEL", "gpt-4o-mini"))
    ...
    def process_documents(self, documents):
        ...
        if not texts:
            raise ValueError(
                "No text chunks produced from documents. Check the loader or text splitter settings."
            )
