...
def parse_args() -> ForecastConfig:
    parser = argparse.ArgumentParser(description="Weather forecasting using lag features and RandomForest")
    ...
    parser.add_argument("--n-lags", dest="n_lags", type=int, default=24, help="Number of lag features")
    parser.add_argument("--test-size", dest="test_size", type=int, default=168, help="Test set size (last N points)")
    parser.add_argument("--n-estimators", dest="n_estimators", type=int, default=300, help="Number of trees in RF")
